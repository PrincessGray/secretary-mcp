...
public interface McpServer {
	...
	class AsyncSpecification {
		...
		private UserSecretaryRegistry userSecretaryRegistry;
		...
		/**
		 * Sets the user secretary registry for the server.
		 * @param registry the user secretary registry to set. Must not be null.
		 * @return This builder instance for method chaining
		 * @throws IllegalArgumentException if registry is null
		 */
		public AsyncSpecification userSecretaryRegistry(UserSecretaryRegistry registry) {
			Assert.notNull(registry, "User secretary registry must not be null");
			this.userSecretaryRegistry = registry;
			return this;
		}
		...
		public McpAsyncServer build() {
			...
			var asyncServer = new McpAsyncServer(this.transportProvider, mapper, features, this.userSecretaryRegistry);
			return asyncServer;
		}
